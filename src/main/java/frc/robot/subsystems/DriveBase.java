...
//When Y value is 0 (to avoid divide by 0 errors)
    ...
    LeftSide.setVoltage(12*Xjoy.getAsDouble()/Math.abs(Xjoy.getAsDouble()));

    RightSide.setVoltage(-12*Xjoy.getAsDouble()/Math.abs(Xjoy.getAsDouble()));
...
//When X value is 0 (to avoid divide by 0 errors)
      ...
      LeftSide.setVoltage(-12*Yjoy.getAsDouble()/Math.abs(Yjoy.getAsDouble()));

      RightSide.setVoltage(-12*Yjoy.getAsDouble()/Math.abs(Yjoy.getAsDouble()));
...
// Quaderants top left and bottom right. (left motor changes voltage)
        ...
        LeftSide.setVoltage(-12*Xjoy.getAsDouble()*Math.cos(2*Math.atan(Xjoy.getAsDouble()/Yjoy.getAsDouble()))/Math.abs(Xjoy.getAsDouble()));
...
// Quaderants top right and bottom left. (right motor changes voltage)
        ...
        RightSide.setVoltage(12*Xjoy.getAsDouble()*Math.cos(2*Math.atan(Xjoy.getAsDouble()/Yjoy.getAsDouble()))/Math.abs(Xjoy.getAsDouble()));
